...
%     \end{lem}
	...
	\nodepart[text width=2.5cm]{five} 
       ...
       \node[circle, thick, blue, fill=lime, draw, diameter=1cm] at (0.875,-1.875) {\tiny{$i$}};
       \node[circle, thick, blue, fill=lime, draw, diameter=1cm] at (1.325,-2.125) {\tiny{$j$}};
      \end{tikzpicture}
    \end{center}
  }
